                                    ...
                                    @if ($permiso->name == "Acceso Full")
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="{{ route('role.index') }}">Crear Role</a>
                                                <a class="dropdown-item" href="{{ route('project.create') }}">Crear
                                                    Projecto</a>
                                                <a class="dropdown-item" href="{{ route('permiso.index') }}">Permisos</a>
                                                <a class="dropdown-item" href="{{ route('home') }}">Projectos</a>
